...
const Review = ({ reviewMassage }) => {
  ...
  const { email, review, rating, img, food, serviceName, date } = reviewMassage;
  return (
    <div>
      <div className="card w-full bg-base-100 shadow-2xl  mb-5 ">
        ...
        <div className="p-5 w-80">
          <p className="card-title text-xl font-bold">Food Name: {serviceName}</p>
          <p className=" text-orange-600 text-xl font-bold">Review: {review}</p>
        </div>
          <figure>
          <img
            src={img}
